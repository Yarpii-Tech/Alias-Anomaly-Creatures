...
null = [_mapMarkerName,200,true,0.1,50] execvm "scripts\anomaly\AL_strigoi\strigoi.sqf";
...
_customGearSet = ["srifle_DMR_05_hex_F",["muzzle_snds_93mmg","optic_Arco","bipod_02_F_blk"],[["10Rnd_93x64_DMR_05_Mag",4],["Titan_AT",1]],"",[""],["Rangefinder","ItemGPS"],"launch_O_Titan_short_ghex_F","H_PilotHelmetFighter_B","U_I_GhillieSuit","V_PlateCarrierSpec_blk","B_Carryall_ghex_F"];
...
_box enableRopeAttach SC_SpectreropeAttach;
...
_veh = [[[(_position select 0) -(34-(random 1)),(_position select 1) +(16+(random 5)),0]],
_group,"assault","hardcore","bandit","random"] call DMS_fnc_SpawnAIVehicle;
_staticGuns =[[
